...
function oddChecker(num) {
	let quiteOdd = num %2 === 1 ? 'the number is odd' : 'the number is even';
	return quiteOdd;
}
...
// console.log(iLove('michael', 'basketball'))
...
myNumbers.forEach((element, i) => myNumbersIndex.push(i))
